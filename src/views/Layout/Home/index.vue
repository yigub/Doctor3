  ...
  <div class="home-page">
    ...
    <div class="home-banner">
      <van-swipe indicator-color="#fff" :autoplay="3000">
        ...
        <van-swipe-item>
          <img src="@/assets/ad2.png" alt="" />
        </van-swipe-item>
      </van-swipe>
    </div>
    <!-- 4.tab标签区 -->
    <van-tabs shrink sticky v-model:active="activeName">
      <van-tab title="推荐" name="like">
        <follow-doctor></follow-doctor>
        <knowledge-list activeType="like"/>
      </van-tab>
      <van-tab title="推荐" name="recommend"><knowledge-list activeType="recommend"/></van-tab>
      <van-tab title="减脂" name="fatReduction"><knowledge-list activeType="fatReduction"/></van-tab>
      <van-tab title="饮食" name="food"><knowledge-list activeType="food"/></van-tab>
    </van-tabs>
  </div>
</template>
...
const activeName = ref<knowledgeType>('like')
// 1.导入useConsultStore仓库
